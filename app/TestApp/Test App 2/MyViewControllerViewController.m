...
- (void)viewDidLoad
{
    ...
    [firstArg setIsAccessibilityElement:YES];
    [firstArg setAccessibilityIdentifier:@"IntegerA"];
    [firstArg setAccessibilityLabel:@"TextField1"];
...
- (void)dealloc {
    ...
    [_computeMinusButton release];
    [answerMinusLabel release];
    [super dealloc];
}
...
- (IBAction)minusAction:(id)sender {
    ...
    int b = [[secondArg text] intValue];
    int minus = a - b;
    NSString *newLabelValue = [NSString stringWithFormat:@"%d",minus];
    [answerMinusLabel setText:newLabelValue];
    [answerMinusLabel setAccessibilityLabel:newLabelValue];
}
